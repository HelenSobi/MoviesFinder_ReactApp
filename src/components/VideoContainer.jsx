        ...
        <section className="relative h-full sm:h-[300px] md:h-[500px] lg:h-[600px] text-white overflow-hidden">
            ...
            {/* Content container with a higher z-index to be above the video */}
                ...
                <div className=" mt-20 md:mt-20 xl:mt-40 md:h-full w-full md:w-6/12 xl:w-5/12">
                    ...
                    <a href="#" className="rounded bg-red-600 px-6 md:px-12 py-2 text-lg font-medium text-white shadow hover:bg-red-700 focus:outline-none focus:ring active:bg-red-500 sm:w-auto">Play</a>
                    <a href="#" className="hidden md:block rounded bg-white px-6 md:px-12 py-3 text-sm font-medium text-red-600 shadow hover:text-red-700 focus:outline-none focus:ring active:text-red-500 sm:w-auto">More Info</a>
                    </div>
                </div>
            </div>
        </section>
