...
const VideoPlayer = () => {
  ...
  return (
    <div className="relative w-full h-[200px] md:h-screen text-white">
      {/* Video iframe */}
      {/* <div className="relative w-full h-[200px] md:h-full lg:h-full"> */}
      <VideoBg movieId={id}/>
{/* </div> */}
      {/* Overlay */}
      <div className="absolute top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center">
        ...
        <div className="w-full md:w-1/2 px-4 md:px-8">
          {/* Overlay Text */}
          {/* Buttons */}
          <h1 className=" text-2xl md:text-2xl font-semibold leading-tight mb-4">{title}</h1>
